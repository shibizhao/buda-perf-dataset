...
def t5(training: bool, task: str, config: str, microbatch: int, device: str, data_type: str):
    ...
    if task == "na":
        ...
        # keep same as t5_past_cache_enc_dec implementation
        input_length = 64
        min_new_tokens = 0
        max_new_tokens = 63
